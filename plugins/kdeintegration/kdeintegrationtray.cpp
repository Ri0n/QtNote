...
void KDEIntegrationTray::announcePlasmoidPackageInstalled() const
{
    auto message
        = QDBusMessage::createSignal(QLatin1String("/KPackage/Plasma/Applet"), QLatin1String("org.kde.plasma.kpackage"),
                                     QLatin1String("packageInstalled"));
